...
│   ├── flamp-widget.tsx      # Виджет отзывов Flamp
...
Отзывы отображаются через официальный виджет Flamp. База данных для хранения отзывов не требуется.
