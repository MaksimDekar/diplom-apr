...
import { FileText, Briefcase, Users, MessageSquare, Settings, Mail, HardHat } from "lucide-react"
      ...
      <main className="ml-64 flex-1 p-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 flex items-center justify-between">
            <div>
              <h1 className="mb-2 font-serif text-3xl font-bold">Панель управления</h1>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Проекты клиентов</CardTitle>
                <HardHat className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{clientProjectsCount || 0}</div>
                <p className="text-xs text-muted-foreground">Объектов на сопровождении</p>
              </CardContent>
            </Card>
          ...
          <Card className="mt-6">
            ...
            <CardContent className="flex flex-wrap gap-3">
              <Button asChild>
                <Link href="/admin/client-projects/new">Создать проект клиента</Link>
              </Button>
              <Button asChild variant="outline">
                <Link href="/admin/client-projects">Открыть проекты клиентов</Link>
              </Button>
              <Button asChild variant="outline">
                <Link href="/admin/contacts">Проверить обращения</Link>
              </Button>
              <Button asChild variant="outline">
                <Link href="/admin/consultations">Проверить консультации</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
